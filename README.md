...
| <b>linkBundling</b>([<i>str</i>]) | Getter/setter for which link/edge bundling to use 'none' or [*edge-path bundling*](https://www.computer.org/csdl/journal/tg/2022/01/09552919/1xibXgJW32U). | `none` |
